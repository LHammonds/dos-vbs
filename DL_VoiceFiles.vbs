Option Explicit
'#############################################################
'## Name         : DL_VoiceFiles.vbs
'## Version      : 1.0
'## Date         : 2004-04-06
'## Author       : LHammonds
'## Purpose      : Move voice files from camera
...
DIM str_path_target
str_path_source_root = "O:\"
str_path_target = "E:\MyData\Voice\New\"

f_move_files str_path_source_root & "DSS_FLDA\", str_path_target
f_move_files str_path_source_root & "DSS_FLDB\", str_path_target
f_move_files str_path_source_root & "DSS_FLDC\", str_path_target
f_move_files str_path_source_root & "DSS_FLDD\", str_path_target
f_move_files str_path_source_root & "DSS_FLDE\", str_path_target
