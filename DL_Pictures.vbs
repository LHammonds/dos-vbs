Option Explicit
'#############################################################
'## Name         : DL_Pictures.vbs
'## Version      : 1.0
'## Date         : 2004-04-06
'## Author       : LHammonds
'## Purpose      : Move pics from camera
...
str_path_target = "E:\Pictures\New\"

f_move_files str_path_source_root & "DCIM\100MSDCF", str_path_target
